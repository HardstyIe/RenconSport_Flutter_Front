...
class TrainingsLists extends StatefulWidget {
  const TrainingsLists({Key? key}) : super(key: key);

  @override
  State<TrainingsLists> createState() => _TrainingsListsState();
}

class _TrainingsListsState extends State<TrainingsLists> {
  @override
